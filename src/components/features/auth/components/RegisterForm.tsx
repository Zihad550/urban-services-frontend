...
export const RegisterForm: React.FC = () => {
    ...
    const { register: registerUser, googleLogin, error, clearAuthError, isLoading } = useAuth();
    ...
    const onSubmit = async (data: RegisterFormData) => {
        ...
        try {
            const registerData = transformRegisterData(data);
            const result = await registerUser(registerData);

            if (result.success) {
                showSuccessToast('Registration successful! Welcome to Urban Services!');
                ...
                if (errorMessage.toLowerCase().includes('email') &&
                    ...
                    // Suggest login if email already exists
                ...
                if (registrationAttempts >= 2) {
                    toast.info('Having trouble registering? Try using Google sign-up instead.');
                }
            }
        } catch (err) {
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="worker">
                                            Service Provider - I provide services
                                        </SelectItem>
                                    </SelectContent>
                                </Select>
                                <FormMessage />
