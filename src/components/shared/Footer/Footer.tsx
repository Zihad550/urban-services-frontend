...
const defaultSections: FooterSection[] = [
    ...
    },
    {
        ...
        links: [
            ...
            { id: 2, text: 'Terms & Conditions', href: '#' }
        ]
    }
];
...
const defaultSocialLinks: SocialLink[] = [
    ...
    },
    {
        name: 'Dribbble',
        href: '#',
        ariaLabel: 'Visit our Dribbble page',
        icon: (
            <svg
                className="size-5"
                fill="currentColor"
...
export const Footer: React.FC<FooterProps> = ({
    className = '',
    companyName = 'Urban Services',
    description = 'Connecting customers with trusted service providers for all your home and business needs. From electricians to chefs, we make finding quality services simple and reliable.',
